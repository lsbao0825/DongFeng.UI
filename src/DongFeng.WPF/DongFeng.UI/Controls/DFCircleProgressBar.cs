...
namespace DongFeng.UI.Controls
{
    ...
    public class DFCircleProgressBar : ProgressBar
    {
        ...
        static DFCircleProgressBar()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(DFCircleProgressBar), new FrameworkPropertyMetadata(typeof(DFCircleProgressBar)));
        }
        ...
        public static readonly DependencyProperty StrokeThicknessProperty =
            DependencyProperty.Register("StrokeThickness", typeof(double), typeof(DFCircleProgressBar), 
        ...
        public static readonly DependencyProperty IsPieProperty =
            DependencyProperty.Register("IsPie", typeof(bool), typeof(DFCircleProgressBar), 
                new PropertyMetadata(false, OnIsPieChanged));

        private static void OnStrokeThicknessChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ((DFCircleProgressBar)d).UpdatePath();
        }
