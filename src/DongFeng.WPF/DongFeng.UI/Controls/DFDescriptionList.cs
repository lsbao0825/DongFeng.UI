...
{
    public class DFDescriptionList : ItemsControl
    {
        static DFDescriptionList()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(DFDescriptionList), new FrameworkPropertyMetadata(typeof(DFDescriptionList)));
        }
