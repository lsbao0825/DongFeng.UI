...
{
    public class DFCodeExample : ContentControl
    {
        static DFCodeExample()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(DFCodeExample), new FrameworkPropertyMetadata(typeof(DFCodeExample)));
        }

        public DFCodeExample()
        {
            Loaded += DFCodeExample_Loaded;
        }

        private void DFCodeExample_Loaded(object sender, RoutedEventArgs e)
        {
            UpdateCode();
        }

        public static readonly DependencyProperty HeaderProperty =
            DependencyProperty.Register("Header", typeof(string), typeof(DFCodeExample), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty CodeProperty =
            DependencyProperty.Register("Code", typeof(string), typeof(DFCodeExample), new PropertyMetadata(null, OnCodeChanged));

        private static void OnCodeChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is DFCodeExample control && !control._isInternalUpdate)
            {
